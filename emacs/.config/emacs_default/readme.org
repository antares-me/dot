  ...
  (use-package telega
    ...
    (progn
      ...
      (setq telega-use-docker t
            ...
            ;;telega-alert-mode t
            telega-language "ru"
            telega-proxies '((:server "127.0.0.1" :port 1443 :type '(:@type "proxyTypeMtproto" :secret "dd5f9e8a468b85abd1f647351a345fad32")))
            )
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (progn
      ...
      (setq org-agenda-files '("~/Dropbox/org/Agenda.org" "~/Dropbox/org/webinar.org" "~/Dropbox/org/workTasks.org"))
