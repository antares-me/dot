    ...
    (use-package telega
      ...
      (progn
        ...
        (setq telega-use-docker t
              ...
              ;;telega-alert-mode t
              telega-language "ru"
              telega-proxies '(:server "mtproto.notamedia.ru" :port 443 :enable t :type '(:@type "proxyTypeMtproto" :secret "QS{guK8N_QtC*:d~`G{rtM/]C")))
  ...
  (use-package gptel
    ...
    (setq gptel-model 'qwen3.5:9b
      ...
      (gptel-make-ollama "Ollama"             ;Any name of your choosing
        ...
        :models '(qwen3.5:9b qwen3:8b codelama:7b))
...
#+begin_src emacs-lisp
  (use-package ellama
    ...
    (setopt ellama-provider
            (make-llm-ollama
             :chat-model "qwen3.5:9b" :embedding-model "qwen3.5:9b"))
    :config
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (progn
      ...
      (setq org-agenda-files '("~/Dropbox/org/Agenda.org" "~/Dropbox/org/webinar.org"))
