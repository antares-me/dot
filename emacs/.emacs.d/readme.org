...
#+BEGIN_SRC emacs-lisp
  (use-package hledger-mode
    ...
    :init
    (setq hledger-jfile
          (expand-file-name "~/MEGA/hledger/2021.journal")
          hledger-email-secrets-file (expand-file-name "secrets.el"
                                                       antares-emacs-temporal-directory))
...
#+BEGIN_SRC emacs-lisp
  (use-package realgud-xdebug
            ...
            :config (setq realgud:xdebug-command-name
                          "/home/antares/bin/dbgpClient"))
#+END_SRC
** Skype
#+BEGIN_SRC emacs-lisp
  (use-package skype
    :straight (skype :type git :host github :repo "kiwanami/emacs-skype")
    :config
    (setq skype--my-user-handle "antares.me"))
#+END_SRC
** swiper & ivy & counsel
...
#+BEGIN_SRC emacs-lisp
  (use-package telega
    ...
    ;(setq telega-open-file-function 'xdg-open)
