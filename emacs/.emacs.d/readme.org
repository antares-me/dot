...
;; сломанных пакетов.
    ...
    ;; Установка diminish, если не существуе
...
[[https://github.com/emacsorphanage/direx][direx]] позволяет просматривать дерево файлов.
...
[[https://github.com/emacsorphanage/go-direx][go-direx]] позволяет просматривать код go в дереве файлов direx.
